...
# TN13. Nghiên cứu phản ứng riêng của alk-1-in (C₂H₂) với dung dịch AgNO₃ trong NH₃
...
<YouTube
  id="KKz08y67AeQ"
  title="Nghiên cứu phản ứng riêng của alk-1-in (C₂H₂) với dung dịch AgNO₃ trong NH₃"
/>
...
<FAQ
  question="H1: Vì sao thêm NaOH loãng trước khi nhỏ NH₃ vào dung dịch AgNO₃?"
  answer={
    <>
...
<FAQ
  question="H2: Hiện tượng nào chứng minh phản ứng đặc trưng của C₂H₂ với AgNO₃/NH₃?"
  answer={
...
<FAQ
  question="H3: Viết phương trình ion rút gọn của phản ứng."
  answer={<>→ Đáp án: HC≡CH + 2Ag⁺ → Ag₂C₂↓ + 2H⁺.</>}
/>

<FAQ
  question="H4: Nếu thay C₂H₂ bằng C₃H₄ (propyne) thì có hiện tượng tương tự không?"
  answer={<>→ Đáp án: Có, vì propyne cũng là alk-1-in có H linh động ở C≡CH.</>}
/>

<FAQ
  question="H5: Vì sao không được để kết tủa Ag₂C₂ khô ngoài không khí?"
  answer={
    <>
