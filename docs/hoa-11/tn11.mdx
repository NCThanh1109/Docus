...
# TN11. Phản ứng oxi hóa của ethylen (C₂H₄ + KMnO₄)
...
<YouTube id="xuoyDFwaQjc" title="Phản ứng oxi hóa của ethylen (C₂H₄ + KMnO₄)" />
...
<FAQ
  question="H1: Vì sao KMnO₄ mất màu khi dẫn khí C₂H₄ qua?"
  answer={
    <>
...
<FAQ
  question="H2: Viết phương trình phản ứng oxi hóa của C₂H₄ với KMnO₄."
  answer={<>→ Đáp án: 3C₂H₄ + 2KMnO₄ + 4H₂O → 3C₂H₄(OH)₂ + 2MnO₂ + 2KOH.</>}
/>

<FAQ
  question="H3: Phân biệt phản ứng của C₂H₄ với Br₂ và với KMnO₄."
  answer={
    <>
...
<FAQ
  question="H4: Nếu thay C₂H₄ bằng CH₄ (metan), hiện tượng có tương tự không?"
  answer={
    <>
...
<FAQ
  question="H5: Ứng dụng của phản ứng oxi hóa anken trong thực tế?"
  answer={
    <>
