...
# TN17: Thí nghiệm phenol phản ứng với HNO₃ đặc trong H₂SO₄ đặc
...
<YouTube
  id="b98xqphz050"
  title="Thí nghiệm phenol phản ứng với HNO₃ đặc trong H₂SO₄ đặc"
/>
...
<FAQ
  question="H1: Vì sao phải trộn H₂SO₄ và HNO₃ trước khi cho phenol vào?"
  answer={
    <>
...
<FAQ
  question="H2: Vì sao phải làm lạnh hỗn hợp khi thêm HNO₃?"
  answer={
    <>
...
<FAQ
  question="H3: Viết cơ chế tạo ion nitronium (NO₂⁺)."
  answer={
    <>
      → Đáp án:
      <MathBlock
...
<FAQ
  question="H4: Vì sao nhóm –OH trong phenol làm phản ứng nitro hóa xảy ra dễ hơn benzen?"
  answer={
    <>
...
<FAQ
  question="H5: Ứng dụng của acid picric trong thực tế là gì?"
  answer={
    <>
