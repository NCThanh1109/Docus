...
# TN12. Điều chế và khử tính chất của axetilen (C₂H₂ + Br₂)
...
<YouTube
  id="HW4T0iMVvXE"
  title="Điều chế và thử tính chất của axetilen (C₂H₂ + Br₂)."
/>
...
<FAQ
  question="H1: Vì sao phải nhỏ từ từ nước vào CaC₂?"
  answer={
    <>
...
<FAQ
  question="H2: Vì sao dung dịch brom mất màu khi dẫn khí C₂H₂ qua?"
  answer={
    <>
...
<FAQ
  question="H3: Viết phương trình phản ứng điều chế axetilen trong thí nghiệm."
  answer={<>→ Đáp án: CaC₂ + 2H₂O → C₂H₂ + Ca(OH)₂.</>}
/>

<FAQ
  question="H4: So sánh phản ứng của C₂H₂ với C₂H₄ khi cho vào nước brom."
  answer={
    <>
...
<FAQ
  question="H5: Ứng dụng thực tế của phản ứng này là gì?"
  answer={
    <>
